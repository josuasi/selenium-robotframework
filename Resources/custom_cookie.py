...
class CookieKeywords(LibraryComponent):
    ...
    @keyword
    def customized_get_cookies(self):
        fcookies = self.driver.get_cookies()
        return fcookies

    @keyword
    def customized_load_cookies(self, cookies, url: Optional[str] = None):
        self.driver.delete_all_cookies()
    ...
    # @keyword
    # def get_xdemia_local_storage(self):
    #     x = self.driver.execute_script("return window.localStorage.getItem('accessToken')")
    #     y = self.driver.execute_script("return window.localStorage.getItem('refreshToken')")
    #     getLocStorage = dict(accessToken=x, refreshToken=y)
    #     return getLocStorage

    # @keyword
    # def set_xdemia_local_storage(self, getLocStorage: dict = True):
    #     self.driver.execute_script("window.localStorage.setItem('accessToken', '{0}')".format(str(getLocStorage['accessToken'])))
    #     self.driver.execute_script("window.localStorage.setItem('accessToken', '{0}')".format(str(getLocStorage['refreshToken'])))
    #     print(getLocStorage['accessToken'], getLocStorage['refreshToken'])
